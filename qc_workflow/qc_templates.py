...
CACHE_DIRECTORY = OUTPUT_ROOT / "continuous_cache"
...
# Raw contact numbering is provisionally MATLAB one-based. The report tests
# +/-1 CSD-row shifts; set "raw-zero" if CSV contacts are zero-based.
SETTINGS = Settings(anchor_convention="raw-one", low_hz=0.5, high_hz=100.0,
